...
L1 = length(initial_displacement);
L2 = length(initial_charge);
...
x0 = [initial_displacement; initial_charge];
x0dot = [initial_current; initial_current];
...
for i = 1: L1
    [t, y] = ODE_2nd_Order_NL(t_start, t_stop, x0(:,i), x0dot(:,i), M, C, K, F);
